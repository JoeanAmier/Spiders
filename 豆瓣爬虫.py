...
def askURL(douban):
    # 设置浏览器UA
    User = {"User-Agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36 Edg/84.0.522.40Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36 Edg/84.0.522.40"}
    # 携带参数访问网址
...
if __name__ == '__main__':
    means = str(input('输入保存形式：表格、SQLite、MySQL'))
    start = time.time()
    main(means)
